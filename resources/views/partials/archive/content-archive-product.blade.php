                    ...
                    <div class="card-services col-12 col-md-6 col-lg-4">
                        <a class="position-relative h-100 d-block overflow-hidden" href="{{ get_term_link($category) }}">
                            ...
                            <div class="product-count">
                                <div class="bg">
                                  <svg width="100" height="142" viewBox="0 0 100 142" fill="none" xmlns="https://www.w3.org/2000/svg">
                            ...
                            <div class="content">
                              ...
                              <div class="cta d-flex align-items-center justify-content-end gap-1 mt-1">
                                  ...
                                  <span class="icon">
                                      <svg class="svg-arrow" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="https://www.w3.org/2000/svg">
