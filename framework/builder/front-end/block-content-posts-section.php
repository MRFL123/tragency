                                                ...
                                                <div class="d-flex flex-column flex-lg-row gap-2 justify-content-between">
                                                    <div class="cat-date d-flex align-items-center gap-3">
                                                        <div class="cat font-16 fw-400 d-flex align-items-center gap-2">
                                                            <div class="icon">
                                                                <svg width="23" height="24" viewBox="0 0 24 25" fill="none" xmlns="https://www.w3.org/2000/svg">
                    ...
                    <div class="modal-content">
                        <div class="modal-header p-0">
                            <button
                                ...
                                "
                            >
                                <svg width="36" height="36" viewBox="0 0 40 40" fill="none" xmlns="https://www.w3.org/2000/svg">
