    ...
    <div class="container">
        ...
        <div class="col-md-5 d-flex align-items-center justify-content-between gap-3">
            ...
            <div class="next-btn pointer">
                <svg class="svg-arrow" width="62" height="62" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <foreignObject x="-13.4" y="-13.4" width="98.8" height="98.8"><div xmlns="http://www.w3.org/1999/xhtml" style="clip-path:url(#bgblur_0_1042_152_clip_path);height:100%;width:100%"></div></foreignObject><g data-figma-bg-blur-radius="13.4">
