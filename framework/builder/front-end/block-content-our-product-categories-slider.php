<?php
/**
 * Block Name : Our Product Categories Slider
 */
...
if ($categories_selection === 'latest') {
    $categories = get_terms(array_merge($term_args, [
        'number'  => 6,
        'orderby' => 'term_id',
        'order'   => 'DESC',
    ]));

} elseif ($categories_selection === 'random') {
    $categories = get_terms(array_merge($term_args, [
        'number'  => 6,
        'orderby' => 'rand',
    ]));

} elseif ($categories_selection === 'select' && !empty($selected_categories)) {
    $include = array_map(function ($term) {
    ...
    <div class="container">
        <div class="row mb-4 align-items-center justify-content-between">
            ...
            <div class="col-md-5 d-flex align-items-center justify-content-between gap-3">
                <div class="prev-btn pointer">
                    <svg class="svg-arrow" width="62" height="62" viewBox="0 0 72 72" fill="none" xmlns="https://www.w3.org/2000/svg">
                        <foreignObject x="-13.4" y="-13.4" width="98.8" height="98.8"><div xmlns="https://www.w3.org/1999/xhtml" style="clip-path:url(#bgblur_0_categories_145_clip_path);height:100%;width:100%"></div></foreignObject><g data-figma-bg-blur-radius="13.4">
                        ...
                        <defs>
                        <clipPath id="bgblur_0_categories_145_clip_path" transform="translate(13.4 13.4)"><rect x="71.5" y="71.5" width="71" height="71" rx="35.5" transform="rotate(180 71.5 71.5)"/>
                        </clipPath></defs>
                    </svg>
                </div>
                ...
                <div class="next-btn pointer">
                    <svg class="svg-arrow" width="62" height="62" viewBox="0 0 72 72" fill="none" xmlns="https://www.w3.org/2000/svg">
                        <foreignObject x="-13.4" y="-13.4" width="98.8" height="98.8"><div xmlns="https://www.w3.org/1999/xhtml" style="clip-path:url(#bgblur_0_categories_152_clip_path);height:100%;width:100%"></div></foreignObject><g data-figma-bg-blur-radius="13.4">
                        ...
                        <defs>
                        <clipPath id="bgblur_0_categories_152_clip_path" transform="translate(13.4 13.4)"><rect x="0.5" y="0.5" width="71" height="71" rx="35.5"/>
                        </clipPath></defs>
                    </svg>
                </div>
            </div>
        ...
        <?php if (!empty($categories)): ?>
            <div class="products-slider">
                ...
                <?php
                    $term = is_object($category) ? $category : get_term((int) $category, 'product-category');
                    if (!$term || is_wp_error($term)) continue;

                    $image     = get_field('category_image', 'product-category_' . $term->term_id);
                    $thumbnail = !empty($image['url']) ? $image['url'] : '';
                    $title     = $term->name;
                    $excerpt   = $term->description ? wp_trim_words($term->description, 20, '...') : '';
                    ...
                    <div>
                        <div class="slider-item pb-4">
                            <div class="slider-image mb-3">
                                <a href="<?= $permalink; ?>">
                                    <?php if ($thumbnail): ?>
                                        <img src="<?= $thumbnail; ?>" alt="<?= esc_attr($title); ?>" class="default-img">
                                    <?php endif; ?>
                                </a>
                            </div>
