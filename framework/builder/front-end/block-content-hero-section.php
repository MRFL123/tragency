...
>
    ...
    <div class="container position-relative z-index-2 h-100 px-md-5">
        ...
        <div class="slick-arrows justify-content-center dots d-flex gap-2">
            <span class="prev-btn pointer">
                <svg width="62" height="62" viewBox="0 0 72 72" fill="none" xmlns="https://www.w3.org/2000/svg">
                    <foreignObject x="-13.4" y="-13.4" width="98.8" height="98.8"><div xmlns="https://www.w3.org/1999/xhtml" style="clip-path:url(#bgblur_0_998_29_clip_path);height:100%;width:100%"></div></foreignObject><g data-figma-bg-blur-radius="13.4">
            ...
            <span class="next-btn pointer">
                <svg width="62" height="62" viewBox="0 0 72 72" fill="none" xmlns="https://www.w3.org/2000/svg">
                    <foreignObject x="-13.4" y="-13.4" width="98.8" height="98.8"><div xmlns="https://www.w3.org/1999/xhtml" style="clip-path:url(#bgblur_0_998_36_clip_path);height:100%;width:100%"></div></foreignObject><g data-figma-bg-blur-radius="13.4">
    ...
    <div class="vector">
        <svg class="svg-arrow" width="855" height="1082" viewBox="0 0 855 1082" fill="none" xmlns="https://www.w3.org/2000/svg">
