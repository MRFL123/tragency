...
<div class="block-section-counter bg-gray-2">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-5 col-12 container-image">
                <?php if ($first_image): ?>
            ...
            <div class="col-md-7 col-12  container-counter ps-md-4">
                <div class="spacer-25"></div>

                <?php if ($title): ?>
                    <h1 class="title font-38 fw-700">
                        <span class="position-relative"><?= $title  ?>
                            <span class="svg mt-4">
                    ...
                    <?php if (have_rows('counters')): ?>
                        ...
                        ?>
                            <div class="col-md-3 col-12">
                                <div class="py-2">
                                    <div class="card-counter text-center rounded shadow bg-white">
                                        <div class="spacer-30"></div>
                                        <div>
                                            <?php if (!empty($icon)): ?>
                                        ...
                                        <h2 class="my-2 font-38 fw-700"><?php echo esc_html($count ?? ''); ?></h2>
